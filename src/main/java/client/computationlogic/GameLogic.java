package client.computationlogic;
...
import client.constants.Rows;
import client.problemdomain.SudokuGame;

import java.util.*;

import static client.problemdomain.SudokuGame.GRID_BOUNDARY;
 ...
 */
public class GameLogic extends GameGenerator{

    public GameLogic(int difficulty) {
        getNewGame(difficulty);
    }

    public static SudokuGame getNewGame(int difficulty) {
